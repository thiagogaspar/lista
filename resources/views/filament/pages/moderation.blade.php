    ...
    <div class="space-y-6">
        <div>
            ...
            <div class="space-y-2">
                ...
                <div class="p-3 bg-white dark:bg-surface-800 rounded-lg border border-surface-200 dark:border-surface-700">
        ...
        <div>
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <span class="px-2 py-1 text-sm bg-warning-100 dark:bg-warning-900/20 rounded">{{ $tag->name }}</span>
                @empty
